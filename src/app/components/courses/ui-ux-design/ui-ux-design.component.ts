...
export class UIUXDesignComponent {
  ...
  setMeta() {
    ...
    this.titleService.setTitle(
      'ui ux design course in hyderabad with 100% placements | star design institute,www.staruiux.com/'
    );
    ...
    this.metaService.updateTag({
      name: 'description',
      content:
        'Looking for unique UI/UX design training? Explore premier institutes in Hyderabad that offer tailored courses to elevate your career!',
    });
